...
<div class="background">
  <form method="post">
    <div class="container">
      <center>
        <h1>Action on database</h1><hr style="height:2px;border-width:0;color:gray;background-color:gray;width:75%">
      </center>
      <?php 
                ...
                elseif($action_type=='edit'){
                  if($action_table=='service'){
                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_array($res)) {
                            echo "<tr>";
                            echo '<td><input type="radio" style="width:10%;" name="ser" value="'.$row['Service_No'].'"/>    &nbsp;   </td>';
                            foreach ($all_property as $item) {
                                echo '<td>' . $row[$item] . '</td>';
                            }
                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_array($res)) {
                            echo "<tr>";
                            echo '<td><input type="radio" style="width:10%;" name="emp" value="'.$row['Emp_No'].'"/>    &nbsp;   </td>';
                            foreach ($all_property as $item) {
                                echo '<td>' . $row[$item] . '</td>';
                            }
                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_array($res)) {
                            echo "<tr>";
                            echo '<td><input type="radio" style="width:10%;" name="cus" value="'.$row['Customer_Id'].'"/>    &nbsp;   </td>';
                            foreach ($all_property as $item) {
                                echo '<td>' . $row[$item] . '</td>';
                            }
                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_array($res)) {
                            echo "<tr>";
                            echo '<td><input type="radio" style="width:10%;" name="veh" value="'.$row['Vehicle_No'].'"/>    &nbsp;   </td>';
                            foreach ($all_property as $item) {
                                echo '<td>' . $row[$item] . '</td>';
                            }
