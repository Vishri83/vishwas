...
if (isset($_POST['submit'])) {
	...
	if ($password == $cpassword) {
		...
		if (!$result->num_rows > 0) {
			...
			$result = mysqli_query($conn, $sql);
			if ($result) {
				echo "<script>alert('Wow! User Registration Completed.') ;location.replace('index.php'); </script>";
			    //$username = "";
				$email = "";
				$_POST['password'] = "";
				$_POST['cpassword'] = "";
...
<div class="main">
        ...
        <div class="content">
                           <!--<button class="cn"><a href="http://localhost/new/register.php">JOIN US</a></button>-->
